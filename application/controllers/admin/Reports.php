...
class Reports extends AdminController
{
    ...
    public function sales()
    {
        ...
        $subheader_text = setupTitle_text('aside_menu_active', 'reports', 'sales_reports');
    ...
    public function expenses($type = 'simple_report')
    {
        ...
        $subheader_text = setupTitle_text('aside_menu_active', 'reports', 'expenses_report');
        $data['subheading_text'] = $subheader_text;
        $data['subtext_'] = $subheader_text;
    ...
    public function expenses_vs_income($year = '')
    {
        ...
        $subheader_text = setupTitle_text('aside_menu_active', 'reports', 'expenses_vs_income_reports');
        $data['subheading_text'] = $subheader_text;
        $data['subtext_'] = $subheader_text;
