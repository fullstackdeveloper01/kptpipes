...
class Expenses extends AdminController
{
    ...
    public function list_expenses($id = '')
    {
        ...
        $header_text = title_text('aside_menu_active', 'expenses');
    ...
    public function categories()
    {
        ...
        $subheader_text = setupTitle_text('setup_menu_active', 'finance', 'expense_categories');
