...
class Tickets extends AdminController
{
    ...
    public function index($status = '', $userid = '')
    {
        ...
        $header_text = title_text('aside_menu_active', 'support');
        $data['heading_text'] = $header_text;
        $data['_text'] = $header_text;
    ...
    public function priorities()
    {
        ...
        $subheader_text = setupTitle_text('setup_menu_active', 'support', 'tickets_priorities');
    ...
    public function predefined_replies()
    {
        ...
        $subheader_text = setupTitle_text('setup_menu_active', 'support', 'tickets_predefined_replies');
        $data['subheading_text'] = $subheader_text;
        $data['subtext_'] = $subheader_text;
    ...
    public function statuses()
    {
        ...
        $subheader_text = setupTitle_text('setup_menu_active', 'support', 'tickets_statuses');
        $data['subheading_text'] = $subheader_text;
        $data['subtext_'] = $subheader_text;
    ...
    public function services()
    {
        ...
        $subheader_text = setupTitle_text('setup_menu_active', 'support', 'tickets_services');
        $data['subheading_text'] = $subheader_text;
        $data['subtext_'] = $subheader_text;
