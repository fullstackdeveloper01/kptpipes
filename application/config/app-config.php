...
*/
define('APP_ENC_KEY', 'fa77816eed024bb3a864b2b2e89c78f0');
 ...
 */
define('APP_DB_USERNAME', 'kptpipes_kptpipesmanage');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 's{,V~jngh9PG');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'kptpipes_kptpipes');
