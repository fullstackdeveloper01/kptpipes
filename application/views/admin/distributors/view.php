            ...
            <div class="panel-body">
                ...
                <div class="row">
                   <div class="col-md-4 form-group">
                       ...
                       <input type="text" class="form-control" required id="distributor_dob" name="distributor_dob" value="<?= (isset($article)?$article->distributor_dob:""); ?>">
                   </div>
                   <div class="col-md-4 form-group">
                ...
                <div class="row">
                   <div class="col-md-6 form-group">
                       <a href="<?= admin_url('distributors')?>" class="btn btn-info">Back</a>
                   </div>
                  </div>
            </div>
          </div>
...
<?php init_tail(); ?>
  <script>
    ...
    /*initDataTable('.table-distributors', window.location.href, '', '','', [0, 'asc']);*/

    if(pagename_ == 'college_slider')
    {
      initDataTable('.table-college_slider', admin_url + 'distributors/table_slider/' + college_id, '','', '', [0, 'desc']);
      appValidateForm($('#import_form'),{slider:{extension: "png,jpg,jpeg,gif"}});
    }
    if(pagename_ == 'faculty')
    {
      initDataTable('.table-college_faculty', admin_url + 'distributors/table_faculty/' + college_id, '','', '', [0, 'desc']);
