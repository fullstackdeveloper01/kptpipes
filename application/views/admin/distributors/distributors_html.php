      ...
      <div class="row">
        <?php
          if(@$article->id != '')
          {
            ?>
              <div class="col-md-3">
                <?php $this->load->view('admin/distributors/sidebar'); ?>         
              </div>
              <div class="col-md-9">
                <div class="panel_s">
                  <div class="panel-body">
                    <?php $this->load->view('admin/distributors/'.$pagename); ?>
                  </div>
                </div>
              </div>  
            <?php
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row">
                      <div class="col-md-6 form-group">
                        <a href="<?= admin_url('distributors')?>" class="btn btn-warning">Go Back</a>
                      </div>
                    </div>
                  </div>
                </div>
