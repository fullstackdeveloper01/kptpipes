         ...
         <div class="row">
            <div class="col-md-12">
                  ...
                  <div class="content-menu hide">
                     <ul>
                        ...
                        <?php
                           ...
                           $copy_template .= "</div>";
                           ?>
                        <li> <a href="#" onclick="return false;" data-placement="bottom" data-toggle="popover" data-content="<?php echo htmlspecialchars($copy_template); ?>" data-html="true"><?php echo _l($header_text.' copy'); ?></span></a>
                        </li>
                        <?php } ?>
                        <?php if(has_permission('tasks','','delete')){ ?>
                        <li>
                           <a href="<?php echo admin_url('tasks/delete_task/'.$task->id); ?>" class="_delete task-delete">
                           <?php echo _l($header_text.' single delete'); ?>
                           </a>
                        </li>
                        <?php } ?>
                     </ul>
               ...
               <div class="checkbox checkbox-primary no-mtop checkbox-inline task-add-edit-public">
                  ...
                  <label for="task_is_public" data-toggle="tooltip" data-placement="bottom" title="<?php echo _l('task_public_help'); ?>"><?php echo _l($header_text.' public'); ?></label>
               </div>
