	...
	<div class="content">
		<div class="row"><?php /* ?>
			<div class="col-md-3">
			    <div class="panel_s">
			        <div class="panel-body">
			            <h4 class="customer-profile-group-heading"><?= _l('Country bulk upload'); ?></h4>
						<hr class="hr-panel-heading" />
    				    <div class="form-group">
					       <a href="<?= admin_url('location/sampledata'); ?>" class="btn btn-success">Download Sample</a>
					   </div>
					   <?= form_open_multipart(admin_url('location/save'));  ?>
    					   <div class="form-group">
			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						<h4 class="customer-profile-group-heading"><?= _l('Country'); ?></h4>
						<hr class="hr-panel-heading" />
						<?= form_open(admin_url('location/add'));  ?>
        					<div class="row form-group">
        					   ...
        					   <div class="col-md-6"><br>
        					       <button type="submit" class="btn btn-info">Save Country</button>
        					   </div>
        					</div>
        				</form>
        				<hr class="hr-panel-heading" />
		    ...
		    <div class="col-md-3">
			    <div class="panel_s">
			        <div class="panel-body">
						...
						<hr class="hr-panel-heading" />
    				    <div class="form-group">
					       <a href="<?= admin_url('location/sampledataCity'); ?>" class="btn btn-success">Download Sample</a>
					   </div>
					   <?= form_open_multipart(admin_url('location/saveCity'));  ?>
    					   <div class="form-group">
		    ...
		    <div class="col-md-3">
			    <div class="panel_s">
			        <div class="panel-body">
						...
						<hr class="hr-panel-heading" />
    				    <div class="form-group">
					       <a href="<?= admin_url('location/sampledataArea'); ?>" class="btn btn-success">Download Sample</a>
					   </div>
					   <?= form_open_multipart(admin_url('location/saveArea'));  ?>
    					   <div class="form-group">
    					       <input type="file" name="fileURL" required id="file-url" class="filestyle" data-allowed-file-extensions="[CSV, csv]" accept=".CSV, .csv" data-buttontext="Choose File">
    					   </div>
    					   <div class="form-groupt">
					...
					<div class="panel-body">
						...
						<?= form_open(admin_url('location/addArea'));  ?>
        					<div class="row form-group">
        					    <div class="col-md-3">
        					       <?= _l('Country'); ?>
        					       <select class="form-control" name="country_id" required onchange="getCitylist(this.value);">
        					           <option value=""></option>
        					           <?php
        					                if($country_result)
        					                {
...
<?php init_tail(); ?>
	<script>
		...
		function getCitylist(Id)
		{
		    ...
		    $.ajax({
		        url: '<?= admin_url()?>location/getCitylist',
		        type: 'POST',
		        data: str,
		        datatype: 'json',
		        cache: false,
