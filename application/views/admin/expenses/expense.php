            ...
            <div class="panel_s">
               <div class="panel-body">
                  <?php
                     ...
                     ?>
                  <h4 class="no-margin"><?php echo $heading_text; ?></h4>
                  ...
                  <div class="checkbox checkbox-primary billable <?php echo $hide_billable_options; ?>">
                     ...
                     <label for="billable" <?php if(isset($expense) && $expense->invoiceid !== NULL){echo 'data-toggle="tooltip" title="'._l($$header_text.' already invoiced').'"'; } ?>><?php echo _l($$header_text.' add edit billable'); ?></label>
                  </div>
                  <div class="form-group select-placeholder">
                     <label for="clientid" class="control-label"><?php echo _l($heading_text.' add edit customer'); ?></label>
