                        ...
                        else
                        {
                            ...
                            if($value == 'email')
                            {
                                ?>
                                  <div class="col-md-6">
                                     ...
                                     <input type="email" id="<?= $value; ?>" value="<?= @$edit_company->email; ?>" name="<?= $value; ?>" class="form-control" <?= (in_array($value, $custome_required))?"required":"";?>/><hr/>
                                  </div>
                               <?php
                            }
                            elseif($value == 'password')
                            {
                                ?>
                                  <div class="col-md-6">
                                     <label><?= ucfirst(str_replace('_',' ',$value)); ?><?= (in_array($value, $custome_required))?"<span class='text-danger'>*</span>":"";?></label>
                                     <input type="password" id="<?= $value; ?>" name="<?= $value; ?>" class="form-control" <?= (in_array($value, $custome_required))?"required":"";?>/><hr/>
                                  </div>
                               <?php
                            }
                            elseif($value == 'zip_code')
                            {
                                ?>
                                  <div class="col-md-6">
                                     <label><?= ucfirst(str_replace('_',' ',$value)); ?><?= (in_array($value, $custome_required))?"<span class='text-danger'>*</span>":"";?></label>
                                     <input type="number" id="<?= $value; ?>" value="<?= $client->zip; ?>" name="<?= $value; ?>" class="form-control" <?= (in_array($value, $custome_required))?"required":"";?>/><hr/>
                                  </div>
                               <?php
                            }
                            elseif($value == 'first_name')
                            {
                                ?>
                                  <div class="col-md-6">
                                     <label><?= ucfirst(str_replace('_',' ',$value)); ?><?= (in_array($value, $custome_required))?"<span class='text-danger'>*</span>":"";?></label>
                                     <input type="text" id="<?= $value; ?>" value="<?= @$edit_company->firstname; ?>" name="<?= $value; ?>" class="form-control" <?= (in_array($value, $custome_required))?"required":"";?>/><hr/>
                                  </div>
                               <?php
                            }
                            elseif($value == 'last_name')
                            {
                                ?>
                                  <div class="col-md-6">
                                     <label><?= ucfirst(str_replace('_',' ',$value)); ?><?= (in_array($value, $custome_required))?"<span class='text-danger'>*</span>":"";?></label>
                                     <input type="text" id="<?= $value; ?>" value="<?= @$edit_company->lastname; ?>" name="<?= $value; ?>" class="form-control" <?= (in_array($value, $custome_required))?"required":"";?>/><hr/>
                                  </div>
                               <?php
                            }
                            else
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <?php 
                    ...
                    ?>
                  <?php echo render_input( 'phonenumber', 'client_phonenumber',$value, 'number', $attrs); }?>
                  <?php 
