         ...
         <div class="col-md-12">
            ...
            <div class="panel_s">
               <div class="panel-body">
                   <h4 class="no-margin"><?= $title; ?> List</h4>
                  ...
                  <div class="row mbot15">
                     ...
                     <div class="col-md-4 col-xs-6 border-right">
                        <h3 class="bold totaluser"><?php echo total_rows(db_prefix().'clients',($where_summary != '' ? substr($where_summary,5) : '')); ?></h3>
                        <span class="text-dark"><?php echo _l($heading_text.' Summary total'); ?></span>
                     </div>
                     <div class="col-md-4 col-xs-6 border-right">
                        <h3 class="bold totalactiveuser"><?php echo total_rows(db_prefix().'clients','active=1'.$where_summary); ?></h3>
                        <span class="text-success"><?php echo _l('Active '.$heading_text); ?></span>
                     </div>
                     <div class="col-md-4 col-xs-6 border-right">
                        <h3 class="bold totalinactiveuser"><?php echo total_rows(db_prefix().'clients','active=0'.$where_summary); ?></h3>
                  ...
                  <div class="checkbox">
                     ...
                     <label for="exclude_inactive"><?php echo _l('exclude_inactive'); ?> <?php echo _l($heading_text); ?></label>
                  </div>
                     ...
                     $_table_data = array(
                      /*'<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="clients"><label></label></div>',*/
                       array(
                         ...
                         array(
                         'name'=>_l('Address'),
                         'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-age')
                        ),
                         array(
...
<script>
   ...
   function customers_bulk_action(event) {
    ...
    function userCounter()
    {
        ...
        setTimeout(function(){
            $.ajax({
                url: admin_url + 'clients/userCounter',
                type: 'POST',
                data: str,
                dataType: 'json',
                cache: false,
                success: function(response){
                    if(response.success == true)
                    {
                        ...
                        $('.totalactiveuser').text(response.totalactiveuser);
                        $('.totalinactiveuser').text(response.totalinactiveuser);
                    }
                    else
                    {
