               ...
               <div class="panel-body _buttons">
                  <div class="row">
                     ...
                     <div class="col-md-5 text-right">
                        ...
                        <a href="#" onclick="<?php echo $invoice_func; ?>(<?php echo $project->id; ?>); return false;" class="invoice-project btn btn-info<?php if($project->client_data->active == 0){echo ' disabled';} ?>"><?php echo _l('invoice '.$heading_text); ?></a>
                        <?php } ?>
                        <?php
