...
<div class="modal fade" id="convert_lead_to_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
               <?php echo _l($heading_text.' convert to client'); ?>
            </h4>
         </div>
      ...
      foreach ($custom_fields as $field) {
         ...
         <hr />
         <p class="bold no-margin"><?php echo _l($heading_text.' merge customer'); ?></p>
         <div class="radio radio-primary">
            ...
            <label for="m_1_<?php echo $field['id']; ?>" class="bold">
               <span data-toggle="tooltip" data-title="<?php echo _l('copy_custom_fields_convert_to_customer_help'); ?>"><i class="fa fa-info-circle"></i></span> <?php echo _l($heading_text.' merge custom field'); ?>
            </label>
         </div>
         <div class="radio radio-primary">
            ...
            <label for="m_2_<?php echo $field['id']; ?>" class="bold">
               <?php echo _l($heading_text.' merge custom field existing'); ?>
            </label>
         </div>
