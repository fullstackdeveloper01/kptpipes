	...
	<div class="content">
		...
		<div class="row" id="subcategory">
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						<h4 class="customer-profile-group-heading"><?= _l('Update Sub-'.$title); ?></h4>
						<hr class="hr-panel-heading" />
						<?= form_open_multipart(admin_url('category/edit/'.$article->id));  ?> 
        					<div class="row form-group">
        					    <div class="col-md-3">
        					       <?= _l('Selected Image'); ?>
        					       <input type="file" class="form-control"  name="category">
