   ...
   <div class="panel_s mbot10">
      <div class="panel-body _buttons">
         ...
         <?php if(has_permission('invoices','','create')){ ?>
            <a href="<?php echo admin_url('invoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list mright5"><?php echo _l('create new '.$subtext_); ?></a>
         <?php } ?>
         <?php if(!isset($project)){ ?>
               <a href="<?php echo admin_url('invoices/recurring'); ?>" class="btn btn-info pull-left">
                  <?php echo _l('recurring '.$subtext_); ?>
               </a>
         <?php } ?>
         <!--
