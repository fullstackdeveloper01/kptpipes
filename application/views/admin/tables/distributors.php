...
foreach ($rResult as $aRow) {
    ...
    */
    ...
    $options = '<a href="'.site_url('distributor-view').'/'.$aRow['id'].'" class="btn btn-info btn-icon"><i class="fa fa-eye" aria-hidden="true"></i></a>';
    $options .= icon_btn('distributors/add/' . $aRow['id'], 'pencil-square-o');
    $options .= '<a href="'.site_url('distributor-rewards').'/'.$aRow['id'].'" class="btn btn-warning btn-icon"><i class="fa fa-gift" aria-hidden="true"></i></a>';
    $row[]   = $options;
