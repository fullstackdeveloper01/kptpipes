...
$join = [
    ...
    'LEFT JOIN '.db_prefix().'dealer ON '.db_prefix().'dealer.id='.db_prefix().'user_reward.user_id',
];

array_push($where, 'AND ('.db_prefix().'user_reward.status = "1" )');
array_push($where, 'AND ('.db_prefix().'user_reward.type = "dealer" )');
...
$result  = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where,[
    ...
    db_prefix().'user_reward.barcode_id',
    db_prefix().'user_reward.message',
    db_prefix().'dealer.dealer_name as username',
]);
