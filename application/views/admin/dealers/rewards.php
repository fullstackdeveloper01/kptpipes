...
<?php init_tail(); ?>
	<script>
		initDataTable('.table-dealer-reward', window.location.href, [1], [1],'', [0, 'desc']);
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <?= form_open_multipart(admin_url('Dealers/claimReward'),array('id' => 'portfolioForm'));  ?>
	        	...
	        	<div class="form-group">
                    ...
                    <input type="text" class="form-control" required pattern="[0-9]*" name="points" placeholder="100">
                </div>
