      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
              <div class="no-margin">
                      <!-- <a href="<?php echo admin_url('dealers/add'); ?>" class="btn btn-info mright5 test pull-right display-block">
                              <?php echo _l('new dealer'); ?>
                            </a> -->
                          </div>
                       <h4><?php echo _l('Dealers List'); ?></h4>
...
<?php init_tail(); ?>
  <script>
    initDataTable('.table-dealers-list', window.location.href, [1], [1], '', [0, 'desc']);
  </script>
