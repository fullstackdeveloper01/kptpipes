                     ...
                     <li class="dd-item dd3-item main<?php echo (!isset($item['collapse']) ? ' dd-nochildren' : ''); ?>" data-id="<?php echo $item['slug']; ?>"<?php if($disabled){echo '  style="opacity:0.5"'; }?>>
                        ...
                        <div class="menu-options main-item-options" style="display:none;" data-menu-options="<?php echo $item['slug']; ?>">
                           ...
                           <div class="input-group">
                            ...
                            <label class="control-label"><?php echo _l('Label'); ?></label>
                            <div class="input-group">
                                <input type="text" value="<?php echo $item['label']; ?>" class="form-control" name="label" id="label-<?php echo $item['slug']; ?>">
                            </div>
                            <label class="control-label"><?php echo _l('Heading'); ?></label>
                            <div class="input-group">
                                <input type="text" value="<?php echo $item['heading']; ?>" class="form-control" name="heading" id="heading-<?php echo $item['slug']; ?>">
                            </div>
                        </div>
                           ...
                           <li class="dd-item dd3-item sub-items" data-id="<?php echo $submenu['slug']; ?>"<?php if($child_disabled){echo '  style="opacity:0.5"'; }?>>
                              ...
                              <div class="menu-options sub-item-options" style="display:none;" data-menu-options="<?php echo $submenu['slug']; ?>">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="text" value="<?php echo $submenu['label']; ?>" class="form-control" name="label" id="label-<?php echo $submenu['slug']; ?>">
                                    
                                 </div>
                                <label class="control-label"><?php echo _l('Heading'); ?></label>
                                <div class="input-group">
                                    <input type="text" value="<?php echo $submenu['heading']; ?>" class="form-control" name="heading" id="heading-<?php echo $submenu['slug']; ?>">
                                </div>
...
<script>
   ...
   function save_menu() {
     ...
     $.each(items, function(key, val) {
       ...
       main_menu.data('label', main_menu.find('#label-'+main_menu.data('id')).val());
       main_menu.data('heading', main_menu.find('#heading-'+main_menu.data('id')).val());
       ...
       $.each(sub_items, function(subKey, val) {
         ...
         sub_item.data('label', sub_item.find('#label-'+sub_item.data('id')).val());
         sub_item.data('heading', sub_item.find('#heading-'+sub_item.data('id')).val());
       });
     });
